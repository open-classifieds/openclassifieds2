...
(0, 'Order shipped for [ORDER.DESC] #[ORDER.ID]', 'order-shipped', 'Hello [USER.NAME],\n\nThanks for buying [ORDER.DESC].\n\nYour order has been shipped.\n\nTracking code [ORDER.SHIPPING_PROVIDER_NAME] [ORDER.SHIPPING_TRACKING_CODE] [URL.QL]', '".core::request('ADMIN_EMAIL')."', 'email', 1),
