...
(0, 'Order shipped for [ORDER.DESC] #[ORDER.ID]', 'order-shipped', 'Hello [USER.NAME],Thanks for buying [ORDER.DESC].\n\nYour order has been shipped.', '".core::request('ADMIN_EMAIL')."', 'email', 1),
(0, 'Order cancelled for [ORDER.DESC] #[ORDER.ID]', 'order-cancelled', 'Hello [USER.NAME],\n\nYour order has been cancelled.', '".core::request('ADMIN_EMAIL')."', 'email', 1),
(0, 'Safe payment request for [AD.NAME]', 'safe-payment-requested', 'Hello [USER.NAME],\n\nYour ad [AD.NAME] received a safe payment request. Please register with Stripe Connect to receive payments [URL.QL].', '".core::request('ADMIN_EMAIL')."', 'email', 1),
...
mysqli_query($link,"INSERT INTO `".core::request('TABLE_PREFIX')."access` (`id_role`, `access`) VALUES
            (10, '*.*'),
            (1, 'profile.*'),(1, 'stats.user'),(1, 'myads.*'),(1, 'escrow.*'),(1, 'mylistings.*'),(1, 'messages.*'),(1, 'ewallet.*'),
            (5, 'translations.*'),(5, 'profile.*'),(5, 'stats.user'),(5, 'content.*'),(5, 'myads.*'),(5, 'escrow.*'),(5, 'mylistings.*'),(5, 'messages.*'),(5, 'ewallet.*'),
            (7, 'profile.*'),(7, 'content.*'),(7, 'stats.user'),(7, 'blog.*'),(7, 'translations.*'),(7, 'ad.*'),
            (7, 'widgets.*'),(7, 'menu.*'),(7, 'category.*'),(7, 'location.*'),(7, 'myads.*'),(7, 'escrow.*'),(7, 'mylistings.*'),(7, 'messages.*'),(7, 'ewallet.*');");
...
('payment', 'stripe_cancel_orders_after_n_days', '0'),
...
('Mark unshipped orders as cancelled', '0 11 * * *', 'Cron_Ad::mark_as_cancelled', NULL, 'Mark unshipped orders as cancelled n days after was paid', 1),
