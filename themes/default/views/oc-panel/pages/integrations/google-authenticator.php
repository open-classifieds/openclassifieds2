    ...
    <div class="flex-1 min-w-0">
        ...
        <div class="mt-1 sm:mt-0">
            <p class="mt-2 items-center text-sm leading-5 text-gray-500">
                <a href="https://guides.yclas.com/#/Security-Two-step-authentication" target="_blank" class="text-blue-600 hover:text-blue-900"><?= sprintf(__('Learn more about %s integration'), 'Google Authenticator') ?></a>
            </p>
        </div>
    </div>
</div>

<?= Form::open(Route::url('oc-panel/integrations', ['controller' => 'googleauthenticator'])) ?>
        ...
        <div class="px-4 py-5 sm:p-6">
            ...
            <div class="mt-2 sm:flex sm:items-start sm:justify-between">
                <div class="max-w-xl text-sm leading-5 text-gray-500">
                    <p>
                        <?= __('2 step authentication with Google Authenticator.') ?>
                    </p>
                </div>
