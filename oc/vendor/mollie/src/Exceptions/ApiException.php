...
class ApiException extends \Exception
{
     ...
     */
    public function __construct($message = "", $code = 0, $field = null, \_PhpScopereac699eb1a3f\Psr\Http\Message\RequestInterface $request = null, \_PhpScopereac699eb1a3f\Psr\Http\Message\ResponseInterface $response = null, $previous = null)
    {
     ...
     * @throws \Mollie\Api\Exceptions\ApiException
     */
    public static function createFromResponse(\_PhpScopereac699eb1a3f\Psr\Http\Message\ResponseInterface $response, \_PhpScopereac699eb1a3f\Psr\Http\Message\RequestInterface $request = null, $previous = null)
    {
