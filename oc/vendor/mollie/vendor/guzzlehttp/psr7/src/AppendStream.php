 ...
 * @final
 */
class AppendStream implements \_PhpScopereac699eb1a3f\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\_PhpScopereac699eb1a3f\Psr\Http\Message\StreamInterface $stream)
    {
    ...
    {
        return \_PhpScopereac699eb1a3f\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
