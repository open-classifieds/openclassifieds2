 ...
 * @final
 */
class LimitStream implements \_PhpScopereac699eb1a3f\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\_PhpScopereac699eb1a3f\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
