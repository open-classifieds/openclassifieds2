 ...
 * @final
 */
class FnStream implements \_PhpScopereac699eb1a3f\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\_PhpScopereac699eb1a3f\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
